...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.ui = uic.loadUi("SPCK/app.ui", self)
        ...
        # self.plus_minus_btn = self.ui.pushButton_3
        # self.percent_btn = self.ui.pushButton_4
        # self.addition_btn = self.ui.pushButton_14
        # self.subtraction_btn = self.ui.pushButton_10
        # self.multiplication_btn = self.ui.pushButton_6
        # self.division_btn = self.ui.pushButton_5
        # self.calculate_btn = self.ui.pushButton_18
    ...
    def calculate(self):
        ...
        # Handle input numbers and decimal point
            ...
            if self.new_input_flag:
                ...
                self.show_text = (
                    self.output.text().replace(",", "") + clicked_btn.text()
                )
        ...
        # Handle operator input
            ...
            try:
                selected_operator = [
                    btn for btn in self.operator_btn_list if btn[0].isChecked()
                ]
                print("abc", selected_operator)
    ...
    def result(self):
        ...
        if self.operator:
            try:
                ...
                self.show_text = str(
                    int(result) if str(result).endswith(".0") else result
                )
                self.set_display_text()
            except Exception:
